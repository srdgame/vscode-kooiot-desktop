...
// @Router /local/user_app/create [post]
export const create_app = (data) => {
  return service({
    url: '/local/user_app/create',
    method: 'post',
    data
  })
}
...
// @Router /local/user_app/delete [delete]
export const delete_app = (data) => {
  return service({
    url: '/local/user_app/delete',
    method: 'post',
    data
  })
}
...
// @Router /local/user_app/update [put]
export const update_app = (data) => {
  return service({
    url: '/local/user_app/update',
    method: 'put',
    data
  })
}
...
// @Router /local/user_app/get [get]
export const get_app = (params) => {
  return service({
    url: '/local/user_app/get',
    method: 'get',
    params
  })
}
...
// @Success 200 {string} string "{"success":true,"data":{},"msg":"查询成功"}"
// @Router /local/user_app/find_by_id [post]
export const find_app_by_id = (data) => {
  return service({
    url: '/local/user_app/find_by_id',
    method: 'post',
    data
  })
}
...
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"
// @Router /local/user_app/list [post]
export const get_app_list = (data) => {
  return service({
    url: '/local/user_app/list',
    method: 'post',
    data
  })
}
